...
class PDF_receipt extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 30, "Husein's Online Store", 0, 1, 'C', true);
    }
    ...
    function Footer() {
        ...
        $this->SetTextColor(0);
        $this->SetXY(0,-60);
        $this->Cell(0, 20, "Thank you and come again!", 'T', 0, 'C');
    }
...
$pdf->Ln(30);
$pdf->Write(13, "bajrektarevic.husein@gmail.com", "mailto:example@example.com");
